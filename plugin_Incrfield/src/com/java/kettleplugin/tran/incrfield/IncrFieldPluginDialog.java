...
public class IncrFieldPluginDialog extends BaseStepDialog implements StepDialogInterface
{
	private IncrFieldPluginMeta input;
	...
	public IncrFieldPluginDialog(Shell parent, Object in, TransMeta transMeta, String sname)
	{
		super(parent, (BaseStepMeta)in, transMeta, sname);
		input=(IncrFieldPluginMeta)in;
	...
	public String open()
	{
		...
		shell.setText(Messages.getString("IncrFieldPluginDialog.Shell.Title")); //$NON-NLS-1$
		...
		wlStepname.setText(Messages.getString("IncrFieldPluginDialog.StepName.Label")); //$NON-NLS-1$
		...
		wlValName.setText(Messages.getString("IncrFieldPluginDialog.FieldName.Label")); //$NON-NLS-1$
		...
		wlValue.setText(Messages.getString("IncrFieldPluginDialog.ValueToAdd.Label")); //$NON-NLS-1$
