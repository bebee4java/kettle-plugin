...
public class ObfusPluginDialog extends BaseStepDialog implements StepDialogInterface
{
	private ObfusPluginMeta input;
	...
	public ObfusPluginDialog(Shell parent, Object in, TransMeta transMeta, String sname)
	{
		super(parent, (BaseStepMeta)in, transMeta, sname);
		input=(ObfusPluginMeta)in;
