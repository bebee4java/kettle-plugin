...
public class ObfusPluginMeta extends BaseStepMeta implements StepMetaInterface
{
	...
	{
		return new ObfusPluginDialog(shell, meta, transMeta, name);
	}

	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp)
	{
		return new ObfusPlugin(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}

	public StepDataInterface getStepData()
	{
		return new ObfusPluginData();
	}
}
